const FriendsAPI = {
  ...
  initialize() {
    ...
    for (var i = 0; i < els.length; i++) {
      ...
      const default_avatar = "https://gcore.jsdelivr.net/gh/cdn-x/placeholder@1.0.12/avatar/round/3442075.svg";
      // layout
      FriendsAPI.request(el, api, function (data) {
...
document.addEventListener("DOMContentLoaded", () => FriendsAPI.initialize());
document.addEventListener("pjax:complete", () => FriendsAPI.initialize());
